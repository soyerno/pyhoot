...
from flask import Blueprint, render_template, request, abort, jsonify, redirect, url_for, request, flash
...
def signup():
    ...
    return render_template('pages/signup.html', props=props)
...
def logout():
    ...
    return render_template('pages/logout.html', props=props)
...
def profile():
    ...
    return render_template('pages/profile.html', props=props)